"""
Django settings for brainshare project.
...
SECRET_KEY = 'django-insecure-3)!hh8fq!!moe-zcf)vkwc-ghim-+(6gq5qf6=brz-)z*035cm'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'brainshare_db_local'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API для платформы обмена знаниями BrainShare',
    'VERSION': '1.0.0',
}
